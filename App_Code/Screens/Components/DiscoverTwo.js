...
export default function DiscoverOne() {
  return (
    <View style={styles.DiscoverOne}>
      ...
      >
        Started in 1822 by Sir Stamford Raffles, the Botanic Gardens is a
        beautiful park in Singapore. Whether you want to spend time with family,
        or take a relaxing stroll through the lush greenery, the Botanic Gardens
        will be a great place to be in.
      </Text>
